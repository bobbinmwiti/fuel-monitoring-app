...
echo sdk.dir=C:/Users/Mwittiiiiiiii/AppData/Local/Android/sdk> "android\local.properties"
echo flutter.sdk=C:/Users/Mwittiiiiiiii/flutter>> "android\local.properties"
echo.

echo Step 4: Updating gradle.properties with correct Java home...
echo org.gradle.java.home=C:/Program Files/Android/Android Studio/jbr> "android\gradle.properties.new"
echo flutter.sdk=C:/Users/Mwittiiiiiiii/flutter>> "android\gradle.properties.new"
...
echo set "JAVA_HOME=C:\Program Files\Android\Android Studio\jbr">> "android\gradlew_fixed.bat"
...
echo Step 8: Building APK with explicit JAVA_HOME...
echo.
cd android
...
echo.
echo If the build failed, try running Android Studio and selecting the correct JDK path:
echo 1. Open Android Studio
echo 2. Go to File > Settings > Build, Execution, Deployment > Build Tools > Gradle
echo 3. Set "Gradle JDK" to the JDK bundled with Android Studio
